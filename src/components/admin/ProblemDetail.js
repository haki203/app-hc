...
export default ProblemDetail = props => {
  try {
      ...
      try {
        const getDetail = async () => {
          ...
          if (res) {
            ...
            console.log("report nay co hinh ", res.report.image.length);
            setImage(res.report.image)
            setLengthImage(res.report.image.length)
            isLoading(false);
          } else {
